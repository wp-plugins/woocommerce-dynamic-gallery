                            ...
                            if(is_array($attached_images) && count($attached_images)>0){
                                ...
                                foreach($attached_images as $item_thumb){
								   ...
								   $img_description = $item_thumb->post_excerpt;
                                    ...
                                    echo '<li class="'.$li_class.'"><a alt="'. esc_attr( $alt ) .'" class="gallery_product_'.$post->ID.' gallery_product_'.$post->ID.'_'.$idx.'" title="'. esc_attr( $img_description ) .'" rel="gallery_product_'.$post->ID.'" href="'.$image_lager_default_url.'"><div><img idx="'.$idx.'" style="width:'.$thumb_width.'px !important;height:'.$thumb_height.'px !important" src="'.$image_thumb_default_url.'" alt="'. esc_attr( $alt ) .'" data-caption="'. esc_attr( $img_description ) .'" class="image'.$i.'" width="'.$thumb_width.'" height="'.$thumb_height.'"></div></a></li>';
