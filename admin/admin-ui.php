...
class WC_Dynamic_Gallery_Admin_UI
{
	...
	public function upgrade_top_message( $echo = false ) {
		$upgrade_top_message = sprintf( '<div class="pro_feature_top_message">' 
			. __( 'Settings inside this yellow border are %s Features.', 'woo_dgallery' ) 
			. '<br />' 
			. __( 'Upgrade to the <a href="%s" target="_blank">%s</a> to activate these settings.', 'woo_dgallery' ) 
			. '</div>'
			, apply_filters( $this->plugin_name . '_pro_version_name', __( 'Pro Version', 'woo_dgallery' ) )
